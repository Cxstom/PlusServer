namespace Plus.HabboHotel.Items.RentableSpaces
{
    public class RentableSpaceItem
    {
        ...
        {
            return this._expireStamp > PlusEnvironment.GetUnixTimestamp();
        }
        ...
        /*  public bool Rented
          {
              get { return this.GetExpireSeconds() > 0 && this.OwnerId > 0; }
              set { if(!value) { this._expireStamp = 0; this._ownerId = 0; this._ownerUsername = ""; } }
          }*/
        ...
        {
            int i = this._expireStamp - (int)PlusEnvironment.GetUnixTimestamp();
            return i > 0 ? i : 0;
        }
