namespace Plus.Communication.Packets.Incoming
{
    public static class ClientPacketHeader
    {
        ...
        public const int AvatarEffectActivatedMessageEvent = -129;//129
        ...
        public const int DropHandItemMessageEvent = -1751;//1751
        ...
        public const int TradingConfirmMessageEvent = -2399;//2399
        ...
        public const int SubmitBullyReportMessageEvent = -1803;//1803
        ...
        public const int GetRoomSettingsMessageEvent = -1014;//1014
        ...
        public const int GetModeratorTicketChatlogsMessageEvent = -3484;//3484
        public const int SetGroupFavouriteMessageEvent = 77;//2625
        public const int ModerationCautionMessageEvent = -505;//505
        ...
        public const int ModerationBanMessageEvent = -2595;//2595
        ...
        public const int GetSanctionStatusMessageEvent = -2883;//2883
        public const int CreditFurniRedeemMessageEvent = 3945;//1676
        public const int DisconnectionMessageEvent = -2391;//2391
        public const int ActionMessageEvent = 3268;//3639
        public const int PickupObjectMessageEvent = 1766;//636
        public const int FindRandomFriendingRoomMessageEvent = -1874;//1874
        public const int UseSellableClothingMessageEvent = 2849;//818
        public const int TradingCancelMessageEvent = 247;//2967
        ...
        public const int TakeAdminRightsMessageEvent = -2725;//2725
        ...
        public const int GiveAdminRightsMessageEvent = -465;//465
        public const int PostGroupContentMessageEvent = 1499;//477
        public const int GetCatalogModeMessageEvent = -2267;//2267
        public const int SendBullyReportMessageEvent = -2973;//2973
        ...
        public const int ModerationKickMessageEvent = -3589;//3589
        ...
        public const int SetRelationshipMessageEvent = -2112;//2112
        ...
        public const int OpenHelpToolMessageEvent = -1839;//1839
        ...
        public const int GetCatalogIndexMessageEvent = -1294;//1294
        ...
        public const int RespectUserMessageEvent = -1955;//1955
        ...
        public const int NewNavigatorSearchMessageEvent = 618;//2722
        ...
        public const int GetHabboClubWindowMessageEvent = -715;//715
        ...
        public const int GetGiftWrappingConfigurationMessageEvent = -1928;//1928
        ...
        public const int ModeratorActionMessageEvent = -781;//781
        ...
        public const int TradingCancelConfirmMessageEvent = -2264;//2264
        public const int SaveEnforcedCategorySettingsMessageEvent = 531;//3413
        public const int TradingAcceptMessageEvent = -3374;//3374
        public const int RespectPetMessageEvent = -1618;//1618
